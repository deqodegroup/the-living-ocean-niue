  ...
  return (
    <main className={`world ${entered ? "entered" : ""} ${awakening ? "awakening" : ""}`} data-scene={activeScene}>
      <div className="scroll-track" ref={trackRef}><div className="world-camera" style={{ "--travel": progress } as CSSProperties}>
        ...
        <Scene index={0} active={activeScene === 0} visited={visitedScenes.includes(0)} progress={progress} className="entry-scene"><video className="hero-video" src="https://the-living-ocean-niue.lordstorm.chatgpt.site/media/01-ocean-wall.mp4" autoPlay muted loop playsInline preload="auto" aria-hidden="true" /><div className="scene-image opening-image" aria-hidden="true" /><div className="entry-copy">
