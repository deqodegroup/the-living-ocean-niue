...
export const OCEAN_CONTEXT = {
  ...
  source:
    "Government of Australia, Pacific Climate Change Science Program and Niue Department of Meteorology and Climate Change (2022), as cited in Niue NDC 3.0",
} as const;
...
export const SOURCES = [
  ...
  },
  {
    ...
    publisher: "Pacific Catastrophe Risk Assessment and Financing Initiative (PCRAFI)",
    year: "2011 · distributed through Pacific Data Hub",
  ...
  },
  {
    ...
    publisher: "Pacific Catastrophe Risk Assessment and Financing Initiative (PCRAFI) / GFDRR / World Bank",
    year: "2011",
    indicator: "National annual average direct loss and return-period loss",
    processing: "Published national loss value transcribed; currency remains USD.",
    url: "https://www.gfdrr.org/en/publication/country-risk-profile-niue",
  },
  {
    title: "Niue Exposure Inventory",
    publisher: "Pacific Catastrophe Risk Assessment and Financing Initiative (PCRAFI) / World Bank / GFDRR",
    year: "2010",
    indicator: "Buildings, major crops and estimated asset replacement value",
    processing: "Used as dated exposure context, not a current asset count.",
    url: "https://www.gfdrr.org/en/publication/country-risk-profile-niue",
  },
  {
    title: "2022 Niue Census of Population and Housing",
    publisher: "Niue Statistics Office",
    year: "2022",
  ...
  {
    title: "Niue NDC 3.0",
    publisher: "Government of Niue · UNFCCC registry",
    year: "2025",
